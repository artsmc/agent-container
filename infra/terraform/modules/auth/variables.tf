# Variables for the auth Cloud Run module.
...
variable "image_url" {
  type        = string
  description = "Full Artifact Registry image URL including tag (e.g. 'us-central1-docker.pkg.dev/project/iexcel-dev/auth:sha-abc123')."
}
