# Outputs from the auth Cloud Run module.

output "service_url" {
  description = "Public HTTPS URL of the auth Cloud Run service (e.g. https://iexcel-dev-auth-hash-uc.a.run.app). Used for direct service invocation and health verification."
...
output "neg_self_link" {
  description = "Self-link of the Serverless NEG. Passed to the DNS module to attach as a backend to the auth backend service stub."
